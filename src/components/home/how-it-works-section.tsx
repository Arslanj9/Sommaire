        ...
        <section className="relative overflow-hidden bg-gray-50">
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 ">
                <div className="text-center mb-16">
                    <h2 className="font-bold text-lg mb-4 text-rose-600">
                        HOW IT WORKS
                    </h2>
    ...
    return (
        <div className="relative p-6 rounded-2xl bg-white/70 border border-transparent hover:border-rose-500/70 hover:bg-rose-50/40 transition-colors group w-full shadow-sm">
            <div className="flex flex-col gap-4 h-full">
                ...
                <h4 className="mt-6 text-lg font-semibold text-center text-rose-600 group-hover:text-rose-700 transition-colors">
                    {label}
                </h4>
